<div class="w3-bar w3-top w3-blue w3-large" style="z-index:4;">
  <button class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-light-grey"><i class="fa fa-bars"></i>  Menu</button>
  	...
  	<span class="w3-bar-item w3-right"> <a href='#'>Xin chào: {{Auth::user()->fullname}}</a> |<a href="update/teacher" style="font-size: 15px;" title="Cập nhật Thông tin"> Cập Nhật...</a> | <a href="/teacher/logout" style="font-size: 15px;">Đăng xuất</a></span>
	@else
